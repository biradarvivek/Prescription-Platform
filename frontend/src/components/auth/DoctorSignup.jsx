...
import { Stethoscope, Upload, ArrowRight } from "lucide-react";
...
const DoctorSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post("/auth/doctor/signup", submitData);
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white">Doctor Sign Up</h2>
          <p className="mt-2 text-white/70">Join our medical platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <div className="flex justify-center">
            <label className="cursor-pointer">
              <input
                ...
                className="hidden"
              />
              <div className="w-24 h-24 rounded-full bg-white/10 border-2 border-dashed border-white/30 flex items-center justify-center hover:border-primary-400 transition-all duration-200 group">
                {profilePicture ? (
                  <img
                  ...
                  <Upload className="h-8 w-8 text-white/50 group-hover:text-primary-400" />
                )}
              </div>
            </label>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              { name: "specialty", type: "text", placeholder: "Specialty" },
