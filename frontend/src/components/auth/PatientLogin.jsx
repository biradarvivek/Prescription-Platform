    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white">Patient Login</h2>
          ...
          <div className="space-y-4">
            ...
            >
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 pr-12"
